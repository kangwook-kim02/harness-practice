...
학생증/재학증명서 기반 인증으로 대학생만 이용할 수 있으며, [Harness 프레임워크](#개발-방법론-harness)로 단계적으로 개발합니다.
...
| 플랫폼 내 메시지 | 매물 기준 1:1 대화 (연락처 미노출) |
...
listings              — 매물 (위치, 가격, 기간, 동의서, 이미지)
conversations         — 매물 기준 1:1 대화방
messages              — 대화방 내 메시지
```
